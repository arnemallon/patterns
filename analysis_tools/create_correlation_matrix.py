#!/usr/bin/env python3
"""
Create Correlation Matrix for Top 8 Bitcoin Features
"""
...
def create_correlation_matrix():
    """Create correlation matrix for top 8 features."""
    ...
    # Top 8 features from our analysis
    ...
    output_path = os.path.join(output_dir, "correlation_matrix_bitcoin.png")
